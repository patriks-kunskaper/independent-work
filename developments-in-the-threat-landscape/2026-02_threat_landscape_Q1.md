...
In December 2025, a Russian state-nexus threat actor conducted destructive cyberattacks against Polish energy infrastructure, representing the first confirmed destructive attack of this kind against NATO infrastructure. The targets included renewable energy farms, a combined heat and power plant, and a manufacturing facility. Entry was gained through VPN devices with absent MFA and default credentials. The objective was not financial. It was destruction of operational capability using wiper malware targeting industrial control systems.
Attribution is contested between credible sources. CERT-Polska and Truesec attribute the attack to Ghost Blizzard (FSB-linked), while CERT-EU drawing on ESET analysis attributes it to Sandworm (GRU-linked). Both are Russian state actors. Neither attribution should be treated as definitive without further corroboration.
...
Sources: CERT-SE Newsletters February 2026, Truesec, CERT-Polska, CERT-EU Threat Landscape Report 2025
